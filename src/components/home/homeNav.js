                ...
                <div className="main-banner" id="none-sm">
                    ...
                    <div className="image-above-content">
                        <div className="mx-5 d-flex justify-content-end">
                            <Button className="text-white px-4" id="connect-btn">Connect Wallet</Button>            
                        </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-7">
                                            <NavLink to="/statistics" id="HomeNavlink">
                                                <div className="box-wrapper">
                                                    <div className="box">
                                                        <p className="text-white"  id="home-hex-routes">Statistics</p>
                                                    </div>
                                                </div>
                                            </NavLink>
                                        </div>
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-8 offset-md-2 p-0">
                                        ...
                                        <input type="text" className="form-control" id="search-field-md" placeholder="Search NFTs,Items,Collections etc." aria-label="Username" aria-describedby="basic-addon1"></input>
                    ...
                    <div className="main-banner">
                        ...
                        <div className="image-above-content pt-2">
                            <div className="mx-3 d-flex justify-content-end">
                                <Button className="text-white px-4" id="connect-btn-sm">Connect Wallet</Button>            
                            </div>
                                ...
                                <div className="row" id="search-row">
                                    ...
                                    <div className="col-10 p-0">
                                        <div className="input-group mt-2 input-group-lg d-flex justify-content-center">
                                            <input type="text" className="form-control" id="search-field-sm" placeholder="Search NFTs,Items,Collections etc."></input>
                                            <i className="fal fa-search text-white" id="search-icon"></i>
                                        </div>
                                    </div>
                                    <div className="col-1"></div>
